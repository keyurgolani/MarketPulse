...
describe('NavigationItem', () => {
  ...
  it('shows active state correctly', () => {
    render(<NavigationItem href="/home" isActive>Home</NavigationItem>);
  ...
  it('calls onClick for links', () => {
    const handleClick = vi.fn();
    render(<NavigationItem href="/home" onClick={handleClick}>Home</NavigationItem>);
  ...
  it('does not call onClick when disabled', () => {
    const handleClick = vi.fn();
    render(<NavigationItem onClick={handleClick} disabled>Disabled</NavigationItem>);
...
describe('MobileNavigation', () => {
  ...
  it('has proper mobile styling', () => {
    ...
    const container = screen.getByText('Mobile Item').parentElement?.parentElement;
...
describe('Breadcrumb', () => {
  ...
  it('applies custom className', () => {
    render(<Breadcrumb items={breadcrumbItems} className="custom-breadcrumb" />);
